...
class BatteryBridge(Node):
    def __init__(self):
        ...
        self.declare_parameter("charger_topic", "charger_connected")   # 네임스페이스 이전 "/pinky1/charger_connected"
        self.declare_parameter("soc_topic", "battery_soc")      # 네임스페이스 이전 "/pinky1/battery_soc"
        self.declare_parameter("volt_topic", "battery_voltage")   # 네임스페이스 이전 "/pinky1/battery_voltage"
